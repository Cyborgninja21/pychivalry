...
class TestCreateDocumentSymbol:
    ...
    def test_create_with_detail(self):
        ...
        symbol = create_document_symbol(
            "my_value", "script_value", 0, 0, 5, 0, detail="Type: fixed"
        )
...
class TestFindSymbolsByName:
    ...
    def test_find_case_insensitive(self):
        ...
        symbols = [create_document_symbol("TestEvent", "event", 0, 0, 10, 0)]
    ...
    def test_find_no_match(self):
        ...
        symbols = [create_document_symbol("event1", "event", 0, 0, 10, 0)]

...
class TestValidateEventFields:
    ...
    def test_missing_title(self):
        ...
        event = Event(event_id="test.0001", event_type="character_event", desc="test.0001.desc")
        is_valid, missing = validate_event_fields(event)
    ...
    def test_missing_desc(self):
        ...
        event = Event(event_id="test.0001", event_type="character_event", title="test.0001.t")
        is_valid, missing = validate_event_fields(event)
        assert is_valid is False
    ...
    def test_invalid_event_type(self):
        ...
        event = Event(event_id="test.0001", event_type="invalid_type")
        is_valid, missing = validate_event_fields(event)
        assert is_valid is False
...
class TestValidateDynamicDescription:
    ...
    def test_valid_triggered_desc(self):
        ...
        config = {"triggered_desc": {"trigger": {"is_adult": "yes"}, "desc": "test.desc"}}
    ...
    def test_triggered_desc_missing_trigger(self):
        ...
        config = {"triggered_desc": {"desc": "test.desc"}}
        is_valid, error = validate_dynamic_description(config)
        assert is_valid is False
    ...
    def test_triggered_desc_missing_desc(self):
        ...
        config = {"triggered_desc": {"trigger": {"is_adult": "yes"}}}
        is_valid, error = validate_dynamic_description(config)
        assert is_valid is False
...
class TestCreateEvent:
    ...
    def test_create_valid_event(self):
        ...
        event = create_event(
            "my_mod.0001", "character_event", title="my_mod.0001.t", desc="my_mod.0001.desc"
        )
    ...
    def test_create_with_theme(self):
        ...
        event = create_event(
            "test.0001", "character_event", title="test.t", desc="test.desc", theme="diplomacy"
        )
...
class TestEventIntegration:
    ...
    def test_letter_event_workflow(self):
        ...
        event = create_event(
            "letters.0001", "letter_event", title="letters.0001.t", desc="letters.0001.desc"
        )

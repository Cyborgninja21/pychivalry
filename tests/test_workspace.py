...
class TestModDescriptorValidation:
    ...
    def test_valid_descriptor(self):
        ...
        descriptor = ModDescriptor(
            name="Valid Mod", version="1.0.0", supported_version="1.11.*", path="mod/valid_mod"
        )
    ...
    def test_descriptor_without_name(self):
        ...
        descriptor = ModDescriptor(
            name="", version="1.0.0", supported_version="1.11.*", path="mod/test"
        )
    ...
    def test_descriptor_without_path(self):
        ...
        descriptor = ModDescriptor(
            name="Test Mod", version="1.0.0", supported_version="1.11.*", path=""
        )
    ...
    def test_descriptor_with_invalid_version_format(self):
        ...
        descriptor = ModDescriptor(
            name="Test Mod", version="1.0.0", supported_version="invalid", path="mod/test"
        )
...
"""
    ...
    def test_calculate_zero_coverage(self):
        ...
        events = {"event_1": "title = event_1.t"}
...
class TestBrokenEventChains:
    ...
    def test_find_broken_event_chains(self):
        ...
        events = {"event_1": "trigger_event = event_2", "event_2": "trigger_event = event_missing"}
        event_files = {"event_1": "file1.txt", "event_2": "file2.txt"}
    ...
    def test_no_broken_chains(self):
        ...
        events = {"event_1": "trigger_event = event_2", "event_2": "add_gold = 100"}
        event_files = {"event_1": "file1.txt", "event_2": "file2.txt"}
...
class TestWorkspaceDiagnostics:
    ...
    def test_diagnostics_summary_with_issues(self):
        ...
        broken_chains = [EventChainLink("event_1", "event_missing", "file.txt", 10, False)]
        ...
        summary = get_workspace_diagnostics_summary(
            undefined_effects, undefined_triggers, broken_chains, loc_coverage
        )
    ...
    def test_diagnostics_summary_clean(self):
        ...
        loc_coverage = LocalizationCoverage(
            total_events=10, events_with_loc=10, missing_keys=[], coverage_percentage=100.0
        )

        summary = get_workspace_diagnostics_summary([], [], [], loc_coverage)

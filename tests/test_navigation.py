...
class TestIsNavigableSymbol:
    ...
    def test_navigable_types(self):
        ...
        navigable = ['event', 'scripted_effect', 'scripted_trigger', 'saved_scope', 'script_value', 'localization_key', 'on_action']
    ...
    def test_find_references(self):
        ...
        index = {
            'references': {
                'event': {
                    'test.0001': [
                        {'uri': 'file:///a.txt', 'line': 5, 'character': 10, 'context': 'reference'},
    ...
    def test_find_references_with_declaration(self):
        ...
        index = {
            'references': {
                'event': {
                    'test.0001': [
                        {'uri': 'file:///a.txt', 'line': 0, 'character': 0, 'context': 'declaration'},
                        {'uri': 'file:///b.txt', 'line': 3, 'character': 5, 'context': 'reference'},
                    ]
                }
            }
    ...
    def test_complete_navigation_workflow(self):
        ...
        index = {
            ...
            'references': {
                'event': {
                    'test.0001': [
                        {'uri': 'file:///usage.txt', 'line': 5, 'character': 10, 'context': 'reference'},
                    ]
                }
            }
        }

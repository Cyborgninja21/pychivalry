...
EVENT_THEMES = {
    ...
    'seduction', 'temptation', 'romance', 'faith', 'culture', 'war', 'death',
    'dread', 'dungeon', 'feast', 'hunt', 'travel', 'pet', 'friendly', 'unfriendly',
    'healthcare', 'physical_health', 'mental_health', 'childhood', 'pregnancy',
    'family', 'realm', 'vassal', 'courtier', 'realm_', 'liege', 'tax',
}
...
PORTRAIT_ANIMATIONS = {
    ...
    'flirtation', 'shock', 'boredom', 'scheme', 'personality_bold',
    'personality_cautious', 'personality_compassionate', 'personality_greedy',
    'personality_honorable', 'personality_rational', 'personality_vengeful',
}

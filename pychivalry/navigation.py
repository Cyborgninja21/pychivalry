...
def create_definition_location(uri: str, line: int, character: int, 
                               symbol_type: str, symbol_name: str) -> DefinitionLocation:
    """
...
def create_reference(uri: str, line: int, character: int, 
                    symbol_length: int, context: str = 'reference') -> Reference:
    """
...
def find_event_definition(event_id: str, document_index: Dict) -> Optional[DefinitionLocation]:
    ...
    return DefinitionLocation(
        ...
        range=location.get('range', types.Range(
...
def find_scripted_effect_definition(effect_name: str, document_index: Dict) -> Optional[DefinitionLocation]:
    """
...
def find_scripted_trigger_definition(trigger_name: str, document_index: Dict) -> Optional[DefinitionLocation]:
    """
...
def find_saved_scope_definition(scope_name: str, document_index: Dict, current_uri: str) -> Optional[DefinitionLocation]:
    """
...
def find_script_value_definition(value_name: str, document_index: Dict) -> Optional[DefinitionLocation]:
    """
...
def find_all_references(symbol_name: str, symbol_type: str, 
                       document_index: Dict, include_declaration: bool = False) -> List[Reference]:
    """
...
def convert_to_lsp_location_link(def_location: DefinitionLocation, 
                                origin_range: types.Range) -> types.LocationLink:
    """
...
def get_symbol_at_position(document_text: str, line: int, character: int) -> Optional[Tuple[str, str]]:
    """

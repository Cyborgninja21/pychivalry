...
LIST_PREFIXES = {
    ...
    'ordered_': {
        'type': 'effect',
        'supported_params': ['limit', 'order_by', 'position', 'max', 'min', 'check_range_bounds', 'save_temporary_scope_as']
    }
}
...
def validate_list_block_content(iterator_info: ListIteratorInfo, 
                                 block_content: str,
                                 inside_limit: bool = False) -> Tuple[bool, Optional[str]]:
    """
...
COMMON_LIST_BASES = {
    # Character lists
    'vassal', 'courtier', 'prisoner', 'child', 'sibling', 'spouse', 
    'ally', 'enemy', 'claim', 'heir', 'heir_to_title', 'heir_title',
    'held_title', 'neighboring_county', 'neighboring_duke', 'neighboring_king',
    'realm_county', 'realm_province', 'realm_de_jure_duchy', 'realm_de_jure_kingdom',
    'character_to_title_neighboring_county', 'character_to_title_neighboring_duke',
    'character_to_title_neighboring_king', 'character_to_title_neighboring_emperor',
    
    # Title lists
    'de_jure_county', 'de_jure_duchy', 'de_jure_kingdom', 'de_jure_empire',
    'county', 'duchy', 'kingdom', 'empire',
    
    # Province lists
    'county_province', 'neighboring_province',
    
    # Dynasty/House lists
    'dynasty_member', 'house_member',
...
def get_list_result_scope(base_name: str, current_scope: str = 'character') -> Optional[str]:
    ...
    title_lists = {
        ...
        'de_jure_county', 'de_jure_duchy', 'de_jure_kingdom', 'de_jure_empire',
        'county', 'duchy', 'kingdom', 'empire',
        'neighboring_county', 'neighboring_duchy', 'neighboring_kingdom',
        'character_to_title_neighboring_county', 'character_to_title_neighboring_duke',
        'character_to_title_neighboring_king', 'character_to_title_neighboring_emperor',
    }
    ...
    province_lists = {
        'realm_province', 'county_province', 'neighboring_province',
    }

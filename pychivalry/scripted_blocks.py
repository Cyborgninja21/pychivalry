...
def validate_scripted_block_call(block: ScriptedBlock, 
                                  provided_params: Dict[str, str]) -> Tuple[bool, Optional[str]]:
    """
...
def get_scripted_block_documentation(block: ScriptedBlock) -> str:
    ...
    # Block type
    block_type_str = "Scripted Trigger" if block.block_type == 'scripted_trigger' else "Scripted Effect"
